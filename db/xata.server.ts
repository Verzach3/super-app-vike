...
const tables = [
  ...
  },
  {
    ...
    revLinks: [
      ...
      { column: "worker", table: "case_workers" },
      { column: "patient", table: "case_workers" },
    ],
  },
  {
    name: "roles",
  ...
  },
  {
    name: "case_workers",
    columns: [
      { name: "worker", type: "link", link: { table: "patient_profiles" } },
      { name: "patient", type: "link", link: { table: "patient_profiles" } },
    ],
  },
] as const;
...
export type CaseWorkers = InferredTypes["case_workers"];
export type CaseWorkersRecord = CaseWorkers & XataRecord;
...
export type DatabaseSchema = {
  ...
  case_workers: CaseWorkersRecord;
};
